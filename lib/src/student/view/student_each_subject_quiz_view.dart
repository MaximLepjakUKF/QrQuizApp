...
class StudentEachSubjectQuizView extends StatelessWidget {
  const StudentEachSubjectQuizView({
    super.key,
                  ...
                  onTap: () {
                    NavigationService().push(
                      QuizQuestionsComponent(
                        appbarTitle:
                            '${FirebaseAccess.firebaseAuthInstance.currentUser!.email!.split('@')[0].toUpperCase()} Quiz Result',
